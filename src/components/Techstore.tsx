    ...
    >
      ...
      <div className="relative mx-auto max-w-[1500px] px-6 py-24 sm:px-8 md:py-32 lg:px-16 lg:py-40">
        ...
        <motion.div
          ...
          className="mb-14 overflow-hidden rounded-2xl border border-yellow-400/20 bg-yellow-400/10 px-6 py-5 md:px-8"
        >
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div className="flex items-start gap-4">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-yellow-400/20 text-yellow-400">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-300">
                  TechStore is currently under development. Product listings and purchasing will be available soon.
                </p>
              </div>
            </div>
            ...
            <a
              href="#contact"
              className="inline-flex shrink-0 items-center gap-2 rounded-full bg-yellow-400 px-5 py-2.5 text-sm font-semibold text-slate-900 transition hover:bg-yellow-300"
            >
              Notify Me
              <ArrowRight size={15} />
            </a>
